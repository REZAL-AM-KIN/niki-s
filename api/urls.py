...
router.register(r"participationevent", views.ParticipationEventViewSet, basename="participationevent")
router.register(r"bucqevent", views.BucqageEventViewSet, basename="bucqevent")
